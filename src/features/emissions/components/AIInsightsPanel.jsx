...
export default function AIInsightsPanel({ insights = [], recommendations = [] }) {
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="border-0 shadow-sm overflow-hidden">
                ...
                <CardHeader className="pb-3">
                    <CardTitle className="flex items-center gap-2 text-base">
                        <div className="bg-linear-to-br from-emerald-500 to-teal-600 rounded-lg p-1.5">
            ...
            <Card className="border-0 shadow-sm overflow-hidden">
                <div className="h-1 bg-linear-to-r from-blue-400 to-indigo-500" />
                <CardHeader className="pb-3">
                    <CardTitle className="flex items-center gap-2 text-base">
                        <div className="bg-linear-to-br from-blue-500 to-indigo-600 rounded-lg p-1.5">
